"""one_fucking_app_23929 URL Configuration
...
admin.site.site_header = "One Fucking App"
admin.site.site_title = "One Fucking App Admin Portal"
admin.site.index_title = "One Fucking App Admin"

# swagger
api_info = openapi.Info(
    title="One Fucking App API",
    default_version="v1",
    description="API documentation for One Fucking App App",
)
